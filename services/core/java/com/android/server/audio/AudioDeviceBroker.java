                    ...
                    synchronized (mDeviceStateLock) {
                        @AudioSystem.AudioFormatNativeEnumForBtCodec final int codec =
                                mBtHelper.getCodecWithFallback(
                                        ...
                                        "MSG_L_BLUETOOTH_DEVICE_CONFIG_CHANGE");
                        final int a2dpCodec = mBtHelper.getCodec(btInfo.mDevice, btInfo.mProfile);
                        mDeviceInventory.onBluetoothDeviceConfigChange(btInfo, codec, BtHelper.EVENT_DEVICE_CONFIG_CHANGE);
                    }
                }    break;
